...
<?
	...
	for ($i=0; $i<$count; $i++)
	{
		...
		$upfile_error[$i]    = $files["error"][$i];	//에러 유무
	...
	if ($mode=="modify")
	{
		...
		for ($i=0; $i<$count; $i++)					// update DB with the value of file input box
		{
			...
			$org_real_value = $copied_file_name[$i];	//2019_03_22_10_07_15_0.jpg
			if ($del_ok[$i] == "y")
			{
				$delete_field = "file_copied_".$i;	//file_copied_0
				$delete_name = $row[$delete_field];	//$row[file_copied_0] -> 2022_02_22_10_43_06_0.jpg
				
				$delete_path = "./data/".$delete_name;	//'./data/2022_02_22_10_43_06_0.jpg
